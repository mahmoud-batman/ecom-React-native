 ...
 * @returns {*}
 */
export const getAllProductAttributes = (lang) => request.get(`/wc/v3/products/attributes?lang=${lang}`);

export const getProductAttributes = (lang, productId) => request.get(`/mobile-builder/v1/attributes/${productId}/?lang=${lang}`);
